...
export const roomResultsConfigDataSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    state.filters.bedTypeFilter.bedFilterArrayOptions = [...filters.bedTypeFilter.bedFilterArrayOptions];
    state.filters.numberOfBedsFilter.showNumberOfBedFilter = filters.numberOfBedsFilter.showNumberOfBedFilter;
    state.filters.numberOfBedsFilter.numberOfBedsFilterOptions = [...filters.numberOfBedsFilter.numberOfBedsFilterOptions];
    ...
    state.filters.roomTypeFilter.roomTypeFilterArrayOptions = [...filters.roomTypeFilter.roomTypeFilterArrayOptions];
